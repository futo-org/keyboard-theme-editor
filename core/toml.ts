...
import { AssetMeta, BackgroundAsset, DefaultAssets, genUniqueName, getFileType, IconAsset, OtherAsset } from "./assets";

export function importToml(file: ArrayBuffer) {
	if(file === undefined) throw new Error("Undefined file!");
